...
<body>
  ...
  <svg viewBox="0 0 600 300" style="width: 100%; font-family: 'Racing Sans One'"  
    ...
    <g text-anchor="right" font-family="Racing Sans One" >
      ...
      <text x=240 y=30 text-anchor="right" fill="#fff">Timestamp</text>
      <text x=390 y=30 text-anchor="right" fill="#fff">Latitude</text>
      <text x=540 y=30 text-anchor="right" fill="#fff">Longitude</text>
    </g>
